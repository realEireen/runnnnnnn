...
var enemy, enemy_running, enemy_collided
...
function preload(){
  ...
  enemy_running = loadAnimation("enemy_1.png", "enemy_2.png", "enemy_3.png")
  enemy_collided = loadAnimation("enemy_collided.png");
...
function setup() {
  ...
  enemy = createSprite(50,height-50,20,50);  

  enemy.addAnimation("running", enemy_running);
  enemy.addAnimation("collided", enemy_collided);
  enemy.setCollider('circle',0,0,350)    
  enemy.scale = 0.08
